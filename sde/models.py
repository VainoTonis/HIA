...
class Evegraphics(models.Model):
    ...
    graphicfile = models.CharField(db_column='graphicFile', max_length=256, blank=True, null=True)  # Field name made lowercase.
...
class Invgroups(models.Model):
    ...
    iconid = models.IntegerField(db_column='iconID', blank=True, null=True)  # Field name made lowercase.
    usebaseprice = models.BooleanField(db_column='useBasePrice', blank=True, null=True)  # Field name made lowercase.
    anchored = models.BooleanField(blank=True, null=True)
    anchorable = models.BooleanField(blank=True, null=True)
    fittablenonsingleton = models.BooleanField(db_column='fittableNonSingleton', blank=True, null=True)  # Field name made lowercase.
    published = models.BooleanField(blank=True, null=True)
...
class Invmarketgroups(models.Model):
    ...
    iconid = models.IntegerField(db_column='iconID', blank=True, null=True)  # Field name made lowercase.
    hastypes = models.BooleanField(db_column='hasTypes', blank=True, null=True)  # Field name made lowercase.
